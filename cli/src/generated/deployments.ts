...
export const DEPLOYMENT_INDEX = {
  ...
  "deployments": [
    ...
    {
      "version": "1.0.0-mixed-testnet.1",
      "network": "base-sepolia",
      "chainId": 84532,
      "status": "candidate",
      "manifest": "base-sepolia/v1.0.0-mixed-testnet.1.json",
      "reason": "Public Mixed v1 CNF_ONLY testnet PoC; test hUSDT, development verifier dependency, deployer-administered policy and no independent audit."
    }
  ]
} as const;
