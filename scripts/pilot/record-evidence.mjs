...
manifest.operationalEvidence={status:'completed',format:evidence.format,evidencePath:relative(process.cwd(),resolve(evidencePath)),evidenceSHA256:createHash('sha256').update(raw).digest('hex'),snapshot:evidence.snapshot,flow:evidence.flow,verifiedAt:new Date().toISOString()};
